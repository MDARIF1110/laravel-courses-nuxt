            ...
            <nav class="flex mt-0">
                <ol role="list" class="flex items-center space-x-0.5">
                    <li>
                        <div class="-m-1">
                            <NuxtLink to="/"
                                class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">Home</NuxtLink>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <div class="-m-1">
                                <NuxtLink to=""
                                    class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">Courses</NuxtLink>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="flex items-center">
                            ...
                            <div class="-m-1">
                                <NuxtLink to=""
                                    class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">{{ course.title }}</NuxtLink>
                            </div>
                        </div>
                    </li>
                </ol>
                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                    ...
                    <ul class="flex flex-wrap items-center gap-4 mt-5 text-gray-700">
                        ...
                        <li class="flex items-center gap-2">
                            ...
                            <span>{{ course.price == 0 ? "Free" : `$${course.price}.00` }}</span>
                        </li>
                    </ul>
                        ...
                        <li class="bg-white rounded-sm shadow">
                            <div class="px-6 py-5">
                                ...
                                <blockquote class="mt-4 sm:mt-6">
                                    <p class="text-base font-normal leading-7 text-gray-600">The best course for Laravel
                                        Developers!</p>
                                </blockquote>
                ...
                <div class="w-1/3 pl-10 pt-0">
                    <div class="mt-2 mb-4 space-y-3">
                        <a href="#" target="_blank"
                            class="flex items-center justify-center w-full px-4 py-3 text-base font-bold text-center text-white transition-all duration-200 border-2 border-transparent rounded focus:outline-none hover:bg-white hover:text-black hover:border-b-2 focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 bg-red-500 hover:border-red-500">
                            Get The Course &nbsp; <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <div class="mt-2 mb-4 space-y-3">
                        <a href="#" target="_blank"
                            class="flex items-center justify-center w-full px-4 py-3 text-base font-bold text-center text-white transition-all duration-200 border-2 border-transparent rounded focus:outline-none hover:bg-white hover:border-b-2 hover:text-black  hover:border-black bg-gray-900">
                            Write A Review &nbsp; <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25">
                                </path>
                    ...
                    <div v-for="author in course.authors" :key="author.id" class="overflow-hidden bg-white border border-gray-200 rounded-sm shadow-sm">
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <div class="mt-8 flex flex-wrap gap-2.5">
                                <NuxtLink to="/"
                                    ...
                                    <div class="ml-3.5 text-sm font-medium text-gray-900">Authontication</div>
                                </NuxtLink>
                                <NuxtLink to="/"
                                    class="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-1.5 hover:bg-gray-100">
                                    <div class="absolute flex flex-shrink-0 items-center justify-center">
                                    ...
                                    <div class="ml-3.5 text-sm font-medium text-gray-900">Laravel</div>
                                </NuxtLink>
                                <NuxtLink to="/"
                                    class="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-1.5 hover:bg-gray-100">
                                    <div class="absolute flex flex-shrink-0 items-center justify-center">
...
const course = await $fetch(`${config.public.apiBase}/single/${route.params.slug}`);
console.log(course)
</script>